    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex flex-1 bg-card items-center justify-center p-8 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-md">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary to-accent flex items-center justify-center mx-auto mb-8 shadow-lg glow-primary">
          ...
          <p className="text-muted-foreground">
            Pick up right where you left off and continue making progress toward your goals.
          </p>
        </div>
      </div>
    </div>
